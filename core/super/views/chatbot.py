...
def _build_store_context():
    """Contexto general de la tienda: productos, marcas, categorías y métodos de pago."""
    try:
        categories = list(
...
class ChatbotProxyView(View):
    ...
    def post(self, request):
        try:
            ...
            # Solo cargamos el contexto de ventas para admins (evita queries innecesarias)
            sales_ctx = _build_sales_context() if is_admin else ""
